...
def multiply_by_two(ti, **context):
...
def subtract_by_three(ti, **context):
...
with DAG(
    ...
    sqaure_number_task = PythonOperator(
        task_id = 'sqaure_number_task',
        python_callable = square_number,
        # provide_context = True
    )

    ## Dependencies
    start_task >> add_five_task >> multiply_by_two_task >> subtract_by_three_task >> sqaure_number_task